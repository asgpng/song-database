...
<div>
  ...
  <?php if ($query->student_progress_eval == '0'): ?> Sensational    <?php endif ?>
  <?php if ($query->student_progress_eval == '1'): ?> Good           <?php endif ?>
  <?php if ($query->student_progress_eval == '2'): ?> Unsatisfactory <?php endif ?>
</div>
<div>
